# W.E. FLOW / W.E. FORGE — Implementation Package v6.0
...
W.E. FLOW is a deterministic, auditable media ingestion engine for professional video production. It ingests raw footage from mixed-camera shoots and produces a structured, classified project folder with five tamper-evident audit log streams.
...
**Governing document:** `we_flow/COMPLIANCE_ROADMAP_v2.0.md` — all compliance controls are falsifiable tests, not assertions.
...
| W.E. FORGE | Platform layer above all phases | Production management, client portal, delivery pipeline | Inherits all phase compliance gates |
