...
**W.E. FORGE** is The Workman Experience's Production Intelligence Platform.
**W.E. FLOW** is the first product — automated multi-camera ingest, scaffold, and proxy generation.

Platform brand leads. W.E. FORGE is announced before W.E. FLOW ships.
W.E. FLOW is described as "the first product from W.E. FORGE."
...
| Decision | Commitment |
|----------|------------|
| Platform brand leads | W.E. FORGE announced before W.E. FLOW ships |
| Local-first core | Creator machine is always source of truth |
| Cloud is optional | No data leaves machine by default — ever |
| In-house core | W.E. FLOW, W.E. EDIT, W.E. ARCHIVE built internally |
...
Location: `~/.weforge/registry/weforge.db`
...
```
1. weforge/ namespace reorganization  ← FIRST — before proxy_workers:4
...
- W.E. FORGE landing page (before W.E. FLOW ships)
...
- W.E. EDIT (J4) — not until W.E. FLOW v1 ships and earns it
...
Technical dependency: same registry and PipelineStage interface as W.E. FLOW.

### W.E. ARCHIVE (J5)
Storage intelligence layer — cross-project deduplication, visual similarity search, cold storage.
Technical dependency: queries the production registry built by W.E. FLOW from day one.
...
- `python3 -m pytest we_flow/tests/ -q` is the current gate
- After weforge/ namespace reorganization: update all imports, verify 95/95 still pass
- Test file location after reorganization: `weforge/tests/`

---

## Competitive Context

W.E. FLOW replaces: Hedge ($99/yr) + manual Finder org + PluralEyes ($199) + Kyno ($149/yr)
