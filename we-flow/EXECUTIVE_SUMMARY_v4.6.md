...
W.E. FLOW is a deterministic media ingestion and organization engine built for professional video production. It solves the first and most time-consuming problem in every production workflow: taking a raw dump of footage from multiple cameras, recorders, and devices — terabytes of unstructured files — and transforming it into a structured, auditable project folder ready for editorial.

A single W.E. FLOW run on a 150 GB, 7-camera shoot takes under 15 minutes and produces:
...
Phase 3 elevates W.E. FLOW from a single-operator CLI tool to a multi-user production platform.
...
- **NLE integration plugins** — Premiere Pro, Final Cut Pro, DaVinci Resolve panels that read W.E. FLOW index JSON directly into the bin
- **Dashboard** — web-based run history, compliance status, and project overview
- **Automated scheduling** — run W.E. FLOW on ingest completion without manual invocation

---

## W.E. FORGE — The Production Intelligence Platform

W.E. FORGE is the production management layer that sits above W.E. FLOW. Where W.E. FLOW handles media ingestion and organization, W.E. FORGE handles the production workflow that surrounds it — from pre-production planning through final delivery.

### W.E. FORGE Capabilities (Roadmap)

| Module | Description |
|---|---|
| **Project Management** | Shot lists, production schedules, crew callsheets — linked to W.E. FLOW project output |
| **Asset Registry** | Every file ingested by W.E. FLOW is a registered asset with provenance, classification, and compliance status |
...
| **AI Workflow Assistant** | W.E. FORGE-native AI that understands the full production context — not a generic chatbot |
...
W.E. FORGE is built on W.E. FLOW's audit log architecture. Every compliance control implemented in Phase 0 through Phase 3 is a native capability of W.E. FORGE — not a bolt-on.
...
W.E. FLOW Phase 0 is a production-grade media ingestion engine with a complete compliance framework. The Phase 0 gate is CONDITIONALLY GREEN — all 26 engineering-controlled compliance metrics pass; the remaining 2 items are Phase 1 scope that do not affect retail distribution.

The path from Phase 0 to W.E. FORGE is a structured four-phase build program with clear scope, falsifiable compliance gates, and attorney-reviewed legal documents at every retail boundary. Each phase is independently shippable.

---

*The Workman Experience, LLC*  
*W.E. FLOW / W.E. FORGE | Phase 0 | v4.6*  
