...
("DWR-039","Road Soul behaviour vocabulary is undeclared, undefined and unenforced","F — Governance Debt",I,
 ...
 "HIGH — it is the difference between a soundtrack and a governed musical language","LOW-MEDIUM (sections 1-3 are transcription; section 4 is real work on four states)","P1","Deferred"),
