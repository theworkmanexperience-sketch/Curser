...
class RunManifest:
    """
    Complete record of a W.E. C.A.P.E. pipeline run.
    ...
    completed_at: str
    runtime_sec: float
    we_cape_version: str = WECAPE_VERSION
    ...
    def to_json(self) -> dict:
        ...
        return {
            ...
            "wecape_version": self.we_cape_version,
            "run": {
                "id": self.run_id,
...
<head>
<meta charset="UTF-8">
<title>W.E. C.A.P.E. — Run Report {self.run_id}</title>
<style>
...
<div class="footer">
  Generated by W.E. C.A.P.E. {self.we_cape_version} &nbsp;|&nbsp;
  W.E. C.A.P.E. CAPTURE — The Production Intelligence Platform
</div>
</body>
</html>"""
    ...
    def to_fcpxml(self) -> str:
        ...
        return (
            ...
            '<!DOCTYPE fcpxml>\n'
            f'<!-- W.E. C.A.P.E. {self.we_cape_version} | Run: {self.run_id} -->\n'
