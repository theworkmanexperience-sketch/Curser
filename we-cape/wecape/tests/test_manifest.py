"""Tests for wecape.core.manifest — RunManifest tri-format output."""

import json
import pytest
from datetime import datetime, timezone, timedelta
from wecape.core.manifest import RunManifest, ContentRecord, StageRecord
